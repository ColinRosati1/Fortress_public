...
import ArmRpc from './fti-flash-node/lib/fti-rpc/arm_rpc.js'
import HaloDemo from '.fti-classes.js'
...
function Fti_Locate(){
  ...
  ArmLocator.scan(4000,function (devlist) {  
